...
df_mitigation <- create_mitigation_df(
  df_default = df_outpatient_constructed_default,
  df_most_severe = df_outpatient_constructed_most_severe,
  df_last_visit_only = df_outpatient_constructed_last_visit_only
)
