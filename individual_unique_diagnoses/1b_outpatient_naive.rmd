...
df_mitigation_without_first_quarters <- create_mitigation_df(
  ...
  mutate(lpr3 = if_else(period > "2019-02-03", 1, 0))
...
undebug(save_mitigation_strategy_plot)
...
save_combined_plots(truncation_plot, p, "combined_naive_individual_unique_diagnoses_with_p_values")
```