...
### Test construct_sequence_ids
test_dfs$construct_sequence_ids <- tibble::tribble(
...
test_dfs$constructed_sequences <- test_dfs$construct_sequence_ids %>% 
...
test_that("Testing construct_sequence_ids", {
...
test_dfs$construct_sequence_ids_no_threshold <- tibble::tribble(
  ~clinic_id, ~patient_id, ~adiagnosekode, ~datotid_start,
  1,             1,         "F0", "2013-07-23 00:00:00",
  1,             1,         "F1", "2013-07-24 00:00:00",
  1,             1,         "F9", "2013-09-25 00:00:00",
...
test_dfs$constructed_sequences_no_threshold <- test_dfs$construct_sequence_ids %>% 
  construct_sequence_ids(
    clinic_id_col = clinic_id,
    patient_id_col = patient_id,
    datetime_col = datotid_start,
...
test_that("construct_sequence_ids without threshold_months", {
  ...
  expect_equal(
    test_dfs$constructed_sequences_no_threshold[["constructed_id"]],
    c("11", "11", "11", "12", "12", "23"),
    fixed = TRUE)
  ## Finished testing 'test_dfs$constructed_sequences'                        ####
})
