...
```{r}
df_outpatient_constructed_no_threshold <- read_csv(here("csv", "df_outpatient_constructed_no_threshold.csv"))
```
...
df_outpatient_constructed_no_threshold_most_severe <- df_outpatient_constructed_no_threshold %>% 
  ...
  write_csv(here("csv", "df_outpatient_constructed_no_threshold_most_severe.csv"))
...
df_outpatient_constructed_no_threshold_last_visit <- df_outpatient_constructed_no_threshold %>% 
  ...
  write_csv(here("csv", "df_outpatient_constructed_no_threshold_final_visit.csv"))
```
...
# Most severe
```{r}
df_outpatient_constructed_no_threshold_most_severe <- read_csv(here("csv", "df_outpatient_constructed_no_threshold_most_severe.csv"))
...
df_sequenced_most_severe <- df_outpatient_constructed_no_threshold_most_severe %>%
  convert_to_sequences_for_incident_per_active()
```
