...
# Final diagnosis
```{r}
df_out_visits_final_visit <- read_csv(here("csv", "df_out_visits_final_visit.csv"))
```
...
df_n_patient_diagnoses_by_quarter_final_visit <- df_out_visits_final_visit %>%
  visits_to_processed_treatment_courses() %>%
  count_unique_diagnoses_in_period()
```
...
df_n_diag_per_patient_final_visit <- join_and_calculate_diagnoses_per_open_sequence(
  df_open_sequences_in_period,
  df_n_patient_diagnoses_by_quarter_no_threshold_final_visit
)
```
...
mitigation_constructed_incident_no_threshold_plot <- save_incident_per_active_plot(
  ...
  p_values = df_plot_mitigation_same_clinic_p_values,
...
df_table <- df_open_sequences_in_period %>%
  ...
  right_join(df_n_patient_diagnoses_by_quarter_no_threshold_final_visit) %>%
