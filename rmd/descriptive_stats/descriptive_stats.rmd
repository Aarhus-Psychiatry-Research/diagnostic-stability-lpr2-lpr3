...
```{r}
max(df_outpatient_visits_preprocessed$datotid_start) # End-date of cohort

length(unique(df_outpatient_visits_preprocessed$dw_ek_borger)) # Number of unique outpatients
...
df_f99_visits <- df_outpatient_visits_preprocessed %>%
