...
```{r}
future(render_with_settings("individual_unique_diagnoses"))
```

```{r}
future(render_with_settings("stability_connected_series"))
```

```{r}
future(render_with_settings("subchapter_props"))
```
