...
```{r}
future_individual <- future(render_with_settings("individual_unique_diagnoses"))
```

```{r}
future_connected_series <- future(render_with_settings("stability_connected_series"))
```

```{r}
future_subchapter <- future(render_with_settings("subchapter_props"))
```
